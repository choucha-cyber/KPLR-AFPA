			...
			<div class="col-lg-12 col-xl-12">
				<div class="tm-intro-text-container">
					...
					<p class="mb-4 tm-intro-text">KPLR construit des solutions
						...
						suppression et à g&eacute;rer la transition qui en r&eacute;sulte.</p>
					<p>KPLR produit des solutions à la demande pour accompagner ses
						clients dans la transformation de l'exploitation des
						donn&eacute;es dont elles disposent</p>
			...
			<div class="col-lg-5">
				<div class="tm-intro-text-container">
					...
					<details>
						...
						<ol>
							<li>cout du mat&eacute;riel</li>
							<li>cout de la maintenance</li>
							<li>cout des diff&eacute;rentes taxes</li>
							<li>cout en terme de locaux</li>
							<li>cout de remplacement</li>
							<li>cout des pannes</li>
							<li>cout du personnel ou des servuces d&eacute;di&eacute;s</li>
							<li>cout des licences</li>
							<li>cuut des risques li&eacute; à l'&eacute;diteur</li>
					...
					<details>
						<summary>
							<p class="mb-4 tm-intro-text">Les actions structurelles :
								produire un "plan Cloud" incluant :Lla chaine de changement que
			...
			<div class="col-lg-5">
				<div class="tm-intro-text-container">
					...
					<p class="mb-4 tm-intro-text">d'une solution optimale pour nos
						...
						d&eacute;ploiement est &eacute;tabli, les moyens a allouer et le objectifs a
						atteindre fix&eacute;s.</p>
			...
			<div class="col-lg-5">
				<div class="tm-intro-text-container">
					...
					<p class="mb-4 tm-intro-text">implantation de la solution. Nos
						ing&eacute;nieurs veillent à la transmission de l'ensemble des
						&eacute;l&eacute;ments du projet, de leur mise en oeuvre, et de
						l'obtention du ou des r&eacute;sultats attendus.</p>
				</div>
			</div>
			...
			<div class="col-lg-5">
				<div class="tm-intro-text-container">
					...
					<p class="mb-4 tm-intro-text">s'agissant de solutions
						...
						clients et de leur assistance tout au long de la vie du projet.</p>
					<div class="tm-continue">
						<a href="catalogue.jsp" class="tm-intro-text tm-btn-primary">D&eacute;tails</a>
					</div>
				</div>
			</div>
