	...
	<section id="infinite" class="text-white tm-font-big tm-parallax">
		...
		<div class="text-center tm-hero-text-container">
			<div class="tm-hero-text-container-inner">
				...
				<p>KPLR développe plusieurs stratégies pour être à la pointe
					des technologies et des innovations en produits et services, afin
					de proposer à ses clients des solutions bien adaptées en
					performances, fiabilité, qualité et coûts.</p>
			</div>
		</div>
				...
				<div class="col-lg-5">
					<div class="tm-intro-text-container">
						...
						<p class="mb-4 tm-intro-text">Nous accompagnons nos clients
							dans l'analyse de leur système dâ'information, et des Datalakes
							quand ils existent de tel sorte à  faire ressortir :</p>
						<ol>
				...
				<div class="col-lg-5">
					<div class="tm-intro-text-container">
						...
						<p class="mb-4 tm-intro-text">Les actions structurelles :
							...
							le passage au cloud induit pour : - L'activité de l'entreprise
							ou du service publique considéré (accroissement du chiffre
							d'affaires, réduction des charges, efficience des services
							proposés, dégagement de ressources que l'entreprise, publique ou
							privée, peut affecter de façon plus efficiente pour accroitre sa
							compétitivité ou réduire son coût.</p>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6">
					...
					<div class="contact-item">
						<a rel="nofollow" href="#" class="item-link"> <i
