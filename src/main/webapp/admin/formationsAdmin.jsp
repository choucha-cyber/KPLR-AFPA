					...
					<tbody>
						<c:forEach items="${formations}" var="formation">
							<tr>
								...
								<td><a
									href="<%=request.getContextPath()%>/admin/updateFormation?formationId=<c:out value="${formation.id_formation }" />"><i
										class="fas fa-pencil-alt tm-pencil-icon text-dark"></i></a></td>
								<td><i class="fas fa-trash-alt tm-trash-icon"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													Voulez vous vraiement supprimer la formation <b>${formation.titre}</b>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary"
														data-bs-dismiss="modal">Non</button>
													<a
														href="<%= request.getContextPath() %>/admin/formationsAdmin?formationId=<c:out value='${formation.id_formation }'/>">
